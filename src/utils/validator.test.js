...
beforeAll(() => {
  ...
  argvDuplicateConfig = ["-c", "C1", "-i", "input.txt", "-o", "output.txt", "--config"];
  argvWrongInputFileConfig = ["-c", "C1", "-i", "wrong_input.txt", "-o", "output.txt"];
  argvWrongOutputFileConfig = ["-c", "C1", "-i", "input.txt", "-o", "wrong_output.txt"];
  argvWrongConfig = ["-c", "C2", "-i", "input.txt", "-o", "output.txt"];
  argvDuplicateInputConfig = ["-i", "input.txt", "-i", "input.txt", "-c", "C1"];
  argvDuplicateInputDiffConfig = ["-i", "input.txt", "--input", "input.txt", "-c", "C1"];
  argvDuplicateOutputConfig = ["-o", "output.txt", "-o", "output.txt", "-c", "C1"];
  argvDuplicateOutputDiffConfig = ["-o", "output.txt", "--output", "output.txt", "-c", "C1"];
});
